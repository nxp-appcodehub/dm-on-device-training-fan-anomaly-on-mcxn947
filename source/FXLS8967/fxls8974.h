...
uint8_t IMU_FXL8974_Read_Byte(uint8_t reg);

uint8_t IMU_FXLS8974_Set_Gyro_Fsr(uint8_t fsr);
uint8_t IMU_FXLS8974_Set_Accel_Fsr(uint8_t fsr);
uint8_t IMU_FXLS8974_Set_LPF(uint16_t lpf);
uint8_t IMU_FXLS8974_Set_Rate(uint16_t rate);
uint8_t IMU_FXLS8974_Set_Fifo(uint8_t sens);
uint16_t IMU_FXLS8974_Get_Fifo_Cnt();



void IMU_FXLS8974_ReadSensorDataToRingBuffer(uint16_t readSize);
